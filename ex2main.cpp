...
int main(void)
{
    cout << "main by kk. Last updated by MSL 28.04.2016\n";
    ...
    string cpt[] = {"to", "jest", "tablica", "wyrazow", "o", "rozmiarze", "jedenascie", "ktore", "beda", "elementami", "macierzy"};
    aghMatrix<string> cpm1(2, 3);
    aghMatrix<string> cpm2(2, 3);
    aghMatrix<string> cpm3(3, 1);
    aghMatrix<string> cpm4;
    aghMatrix<string> cpm5;
    aghMatrix<string>* cpmptr1 = new aghMatrix<string>(1, 1);
    aghMatrix<string> cpmtest1, cpmtest2;
    ...
    // 13th test - operator przypisania p1
    cpm5 = cpm4 = cpm3;
    showTestResult(13, (cpm3 == cpm4) && (cpm3 == cpm5));

    // 14th test - operator przypisania p2
    cpm5.setItem(0, 0, "nothing");
    showTestResult(14, (cpm3 == cpm4) && (cpm3 != cpm5) && (cpm3(0,0) == "wyrazow"));

    // 15th test - operator przypisania
    cpm5 = cpm3;
    try
    {
        cpm5 = cpm5;
        showTestResult(15, cpm3 == cpm5);
    ...
    // 16th test - jawne wywolanie destruktora
    cpm5 = cpm3;
    cpm5.~aghMatrix();
    try
    {
    ...
    // 17th test - operator dodawania
    try
    {
        showTestResult(17, (cpm1+cpm2) == cpmtest1);
    }
    catch(...)
    {
        showTestResult(17, false);
    }
    // 18th test - operator mnożenia
    try
    {
        showTestResult(18, (cpm1*cpm3) == cpmtest2);
    }
    catch(...)
    {
    ...
    // 19th test - operator dodawania
    try
    {
        showTestResult(19, cmplxm4 == cmplxmtest2);
    }
    catch(...)
    {
    ...
    // 20th test - operator mnozenia
    try
    {
        showTestResult(20, (cmplxm1*cmplxm2) == cmplxmtest1);
    }
    catch(...)
    {
